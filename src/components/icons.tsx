...
export const IconUndo = (props: SVGProps<SVGSVGElement>) => (
...
export const IconRedo = (props: SVGProps<SVGSVGElement>) => (
...
export const IconWand = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M15 4V2" /><path d="M15 16v-2" /><path d="M8 9h2" /><path d="M20 9h2" /><path d="M17.8 11.8 19 13" /><path d="M15 9a3 3 0 0 0-3-3" /><path d="M12 12a3 3 0 0 0-3-3" /><path d="M12 12a3 3 0 0 0 3 3" /><path d="M12 12a3 3 0 0 0 3-3" /><path d="m5 11-1 1" /><path d="m2 22 5.5-1.5L21.5 6.5a2.8 2.8 0 0 0-4-4L6 17l-1.5 5.5Z" /></svg>
);

export const IconUploadCloud = (props: SVGProps<SVGSVGElement>) => (
...
export const IconCombine = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect width="8" height="8" x="2" y="2" rx="2" /><path d="M14 2h6a2 2 0 0 1 2 2v6" /><path d="M2 14h6a2 2 0 0 1 2 2v6" /><path d="M14 14h2a6 6 0 0 0 6-6v-2" /><path d="M6 14v2a6 6 0 0 0 6 6h2" /></svg>
);

export const IconSplit = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16 3h5v5" /><path d="M8 3H3v5" /><path d="M12 22v-8.3a4 4 0 0 0-1.172-2.872L3 3" /><path d="M21 21l-7.83-7.83" /><path d="M12 12v10" /></svg>
);
...
export const IconAlertCircle = (props: SVGProps<SVGSVGElement>) => (
